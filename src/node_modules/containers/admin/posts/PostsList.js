...
const PostFormModal = React.createClass({
  ...
  render() {
    ...
    return (
      <Modal {...this.props} bsSize="large" aria-labelledby="contained-modal-title-lg">
        ...
        <Modal.Body>
          <h4>Wrapped Text</h4>
          <p>id={this.props.post_id}</p>
          <PostForm
            initialValues={posts.filter((post) => post.id === post_id)[0]}
            isCreate={false}
            {...this.props}
  ...
  render() {
    ...
    return (
      <div>
        ...
        <PostFormModal show={this.state.modalEdit.Show} post_id={this.state.modalEdit.id} onHide={modalEditClose}
                      posts={posts} {...this.props}/>
        <PostForm
          initialValues={posts.filter((post) => post.id === 2)[0]}
          isCreate={false}
          {...this.props}
